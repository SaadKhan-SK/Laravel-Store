                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-end"> <!-- Updated class name -->
                                <a href="{{ route('vendor.add-product') }}" class="btn btn-success mb-3"><i class="fa fa-plus"></i> Add Product</a> <!-- Removed flex-justify-end class -->
                            </div>
                            <table table id="vendorproductstable" class="table table-bordered dt-responsive  nowrap w-100">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Name</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $product->price }}</td>
                                        <td><a href="{{ route('vendor.add-product',['id'=>$product->id])}}"><i class="fas fa-edit"></i></a></td>
                                        {{-- <a href="{{ route('vendor.edit-product')}}"><i class="fas fa-edit"></i></a> 
                                    </tr>
                                        @endforeach --}}
                                </tbody>
                                <tfoot>
...
<script>
    $(document).ready(function()
    {
        ...
        var table = $('#vendorproductstable').DataTable({
            processing: true,
            serverSide: false,
            ajax: {
            ...
            columns: [{
                ...
                },
                {
                    data: null,
                    render: function(data) {
                        return '<a class="btn btn-info btn-sm" title="View" href="{{ route('vendor.view-product') }}?id=' + data.id +
                            '"><i class="mdi mdi-eye d-block font-size-16"></i></a>'
                            +'<a class="btn btn-success btn-sm mx-2" title="Edit" href="{{ route('vendor.add-product') }}?id=' + data.id +
                            '"><i class="mdi mdi-pencil d-block font-size-16"></i></a>'
                            +'<a class="delete btn btn-danger btn-sm" title="Delete" href="{{ route('vendor.delete-product') }}?id=' + data.id +
