            ...
            <div class="item-shorting clearfix">
                <div class="left-column pull-left clearfix">
                    <div class="filter-box">
                        <div class="dropdown">
                            <button class="search-box-btn" type="button" id="dropdownMenu5" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false"><i class="flaticon-list-2"></i>Filter</button>
                            <div class="filter-content dropdown-menu pull-right search-panel"
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-12 column">
                                            <div class="single-column">
                                                ...
                                                <ul class="color-list clearfix">
                                                    <li><span class="black"></span><a href="single-shop-1.html">Black
                                                            (3)</a></li>
                                                    <li><span class="blue"></span><a href="single-shop-1.html">Blue
                                                            (6)</a></li>
                                                    <li><span class="orange"></span><a href="single-shop-1.html">Orange
                                                            (9)</a></li>
                                                    <li><span class="green"></span><a href="single-shop-1.html">Green
                                                            (5)</a></li>
                                                    <li><span class="purple"></span><a href="single-shop-1.html">Purple
                                                            (3)</a></li>
                                                </ul>
                                            </div>
                                        </div>
            ...
            <div class="our-shop">
                <div class="row clearfix">
                    @foreach ($data['products'] as $product)
                        @if ($product->status != 0 && $product->is_approved != 0 && strtotime($product->publish_date) <= strtotime('today'))
                ...
                <div class="pagination-wrapper centred">
                    <ul class="pagination clearfix">
                        @if ($data['products']->onFirstPage())
                            <li style="color: #999; pointer-events:none;cursor:not-allowed;"><a href="#">Prev</a>
                            </li>
                        @else
                            <li><a href="{{ $data['products']->previousPageUrl() }}">Prev</a></li>
                        @endif

                        @for ($i = 1; $i <= $data['products']->lastPage(); $i++)
                            <li><a href="{{ $data['products']->url($i) }}"
                                    class="{{ $data['products']->currentPage() == $i ? 'active' : '' }}">{{ $i }}</a>
                            </li>
                        @endfor

                        @if ($data['products']->hasMorePages())
                            <li><a href="{{ $data['products']->nextPageUrl() }}">Next</a></li>
                        @else
                            <li style="color: #999; pointer-events:none;cursor:not-allowed;"><a href="#">Next</a>
                            </li>
                        @endif
                    </ul>
                </div>
