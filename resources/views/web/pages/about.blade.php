    ...
    <div class="auto-container">
        <div class="row align-items-center clearfix">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 image-column">
                <figure class="image-box"><img src={{asset("assets/images/resource/about-1.jpg")}} alt=""></figure>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-12 text-column">
                <div class="text-inner">
                    <div class="box">
...
<section class="chooseus-section">
    <div class="outer-container clearfix">
            ...
            <div class="inner-column">
                <div class="content-box">
                    <div class="sec-title style-two">
                        ...
                        <span class="separator" style="background-image: url({{asset('assets/images/icons/separator-3.png')}})"></span>
                    </div>
                    <div class="inner-box">
        ...
        <div class="image-column" style="background-image: url({{asset('assets/images/background/chooseus-bg-1.jpg')}})"></div>
    </div>
</section>
...
<section class="team-section centred">
    <div class="auto-container">
        <div class="sec-title">
            ...
            <p>There are some product that we featured for choose your best</p>
            <span class="separator" style="background-image: url({{asset('assets/images/icons/separator-1.png')}})"></span>
        </div>
        <div class="row clearfix">
