...
<header class="main-header">
    ...
    <div class="header-lower">
        <div class="auto-container">
            <div class="outer-box">
                <figure class="logo-box"><a href="{{ route('home.web') }}"><img src={{asset("assets/images/logo.png")}} alt=""></a></figure>
                <div class="menu-area">
                    ...
                    <nav class="main-menu navbar-expand-md navbar-light">
                        <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                            <ul class="navigation clearfix">
                                <li class="current"><a href="{{ route('home.web') }}">Home</a>
                                    {{-- <ul>
                                ...
                                <li class="dropdown"><a href="index.html">Pages</a>
                                    <ul>
                                        ...
                                        <li><a href="{{ route('team.web') }}">Our Team</a></li>
                                        <li><a href="testimonials.html">Testimonials</a></li>
                                        <li><a href="error.html">404</a></li>
                                    </ul>
                                </li>
                                <li><a href="{{ route('shop.web') }}">Shop</a>
                                    {{-- <div class="megamenu">
        ...
        <div class="auto-container">
            <div class="outer-box clearfix">
                <div class="logo-box pull-left">
                    <figure class="logo"><a href="index.html"><img src={{asset("assets/images/small-logo.png")}} alt=""></a></figure>
                </div>
