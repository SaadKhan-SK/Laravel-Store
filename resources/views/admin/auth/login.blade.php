@include('admin.layouts.header', ['title' => "Login"])
<div class="auth-page">
                        ...
                        <div class="d-flex flex-column h-100">
                            <div class="mb-4 mb-md-5 text-center">
                                <a href="index.php" class="d-block auth-logo">
                                    <img src={{asset("assets/admin/images/logo-sm.svg")}} alt="" height="28"> <span class="logo-txt">Minia</span>
                                </a>
                            </div>
                                ...
                                <form class="mt-4 pt-2" action="{{ route('auth.login') }}" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group auth-pass-inputgroup">
                                            <input type="password" class="form-control" placeholder="Enter password" name="password" value="{{old('password')}}" aria-label="Password" aria-describedby="password-addon">
