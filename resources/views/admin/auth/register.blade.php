@include('admin.layouts.header', ['title' => "Register"])
<div class="auth-page">
                    ...
                    <div class="w-100">
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="auth-content my-auto">
                                ...
                                <form class="needs-validation custom-form mt-4 pt-2" action="{{ route('auth.register') }}"  method="post">
                                    @csrf
                                    <div class="mb-3 ">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="password" class="form-control" id="pasword" placeholder="Enter password" name="password" value="{{old('password')}}">
                                        @error('password')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
